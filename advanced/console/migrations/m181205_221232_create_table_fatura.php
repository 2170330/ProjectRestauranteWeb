...
class m181205_221232_create_table_fatura extends Migration
{
    public function up()
    {
        $tableOptions = null;
        ...
        $this->addForeignKey('fatura_ibfk_1', '{{%fatura}}', 'id_tipo_pagamento', '{{%tipo_pagamento}}', 'id', 'RESTRICT', 'RESTRICT');
        $this->addForeignKey('fatura_ibfk_2', '{{%fatura}}', 'id_user', '{{%user}}', 'id', 'RESTRICT', 'RESTRICT');
        $this->addForeignKey('fatura_ibfk_3', '{{%fatura}}', 'id_refeicao', '{{%refeicao}}', 'id', 'RESTRICT', 'RESTRICT');
    }
