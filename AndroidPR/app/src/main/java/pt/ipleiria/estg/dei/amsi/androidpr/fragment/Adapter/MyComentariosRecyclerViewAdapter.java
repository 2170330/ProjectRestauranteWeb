...
import pt.ipleiria.estg.dei.amsi.androidpr.fragment.ComentariosFragment.OnListFragmentInteractionListener;
...
public class MyComentariosRecyclerViewAdapter extends RecyclerView.Adapter<MyComentariosRecyclerViewAdapter.ViewHolder> {
    ...
    public MyComentariosRecyclerViewAdapter(List<DummyItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
