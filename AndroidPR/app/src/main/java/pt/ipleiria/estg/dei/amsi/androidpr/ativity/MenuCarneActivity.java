...
public class MenuCarneActivity extends AppCompatActivity {
    ...
    private static final String TAG_MENU_CARNE = "Menu Carne";
    public static String CURRENT_TAG = TAG_MENU_CARNE;
    ...
    private void setToolbarTitle() {
        if (navItemIndex != 10) {
            ...
            getSupportActionBar().setTitle(TAG_MENU_CARNE);
        }
    }
